...
| **[📈 FolioLearn — Investor Education Platform](https://github.com/UV012/FinEdu-LMS)** | A SEBI-compliant course marketplace and content platform built in framework-free PHP, with Razorpay checkout, financial calculators, and an admin dashboard. Built as a client architecture demo emphasizing security (CSRF, prepared statements, role-based auth) and transparency over framework convenience. | *React, TypeScript, Node.js, Express, MariaDB, Tailwind CSS* |
| **[🎓 EduCore ERP](https://github.com/UV012/ERP_educore)** | A full-stack college ERP for admissions, fees, and scholarships with role-scoped student/staff/admin portals, JWT auth, per-record ownership checks, rate limiting, and a MariaDB→SQLite auto-failover data layer. React · Node.js/Express · MariaDB. | *React, TypeScript, Node.js, Express, MariaDB, SQLite, Tailwind CSS, Vite, JWT* |
